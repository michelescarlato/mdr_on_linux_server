```
Backing up an object on the server 'PostgreSQL 15 (localhost:5432)' from database 'jprn'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_dump.exe --file "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_jprn.backup" --host "localhost" --port "5432" --username "postgres" --no-password --verbose --format=c --blobs "jprn"
 Start time: Sat Sep 21 2024 18:58:34 GMT+0200 (Central European Summer Time)
...
Execution time: 184.48 seconds
```

```
Restoring backup on the server 'krang linux (leman73.homelinux.org:5432)'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_restore.exe --host "leman73.homelinux.org" --port "5432" --username "postgres" --no-password --dbname "jprn" --verbose "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_jprn.backup"
 Start time: Sat Sep 21 2024 19:03:22 GMT+0200 (Central European Summer Time)
...
pg_restore: creating CONSTRAINT "ad.study_iec_upto12 study_iec_upto12_new_pkey1"
