```
Backing up an object on the server 'PostgreSQL 15 (localhost:5432)' from database 'yoda'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_dump.exe --file "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_yoda.backup" --host "localhost" --port "5432" --username "postgres" --no-password --verbose --format=c --blobs "yoda"
 Start time: Sat Sep 21 2024 21:55:32 GMT+0200 (Central European Summer Time)
...
pg_dump: dumping contents of table "mn.not_registered"
...
pg_dump: dumping contents of table "sd.temp_city_names"
pg_dump: dumping contents of table "sd.temp_country_names"
pg_dump: dumping contents of table "sd.temp_org_names"
...
Execution time: 2.37 second
```

```
Restoring backup on the server 'krang linux (leman73.homelinux.org:5432)'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_restore.exe --host "leman73.homelinux.org" --port "5432" --username "postgres" --no-password --dbname "yoda" --verbose "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_yoda.backup"
 Start time: Sat Sep 21 2024 21:57:46 GMT+0200 (Central European Summer Time)
...
pg_restore: creating TABLE "mn.not_registered"
...
pg_restore: creating TABLE "sd.temp_city_names"
pg_restore: creating TABLE "sd.temp_country_names"
pg_restore: creating TABLE "sd.temp_org_names"
...
pg_restore: processing data for table "mn.not_registered"
...
pg_restore: processing data for table "sd.temp_city_names"
pg_restore: processing data for table "sd.temp_country_names"
pg_restore: processing data for table "sd.temp_org_names"
...
pg_restore: creating CONSTRAINT "mn.not_registered not_registered_pkey"
