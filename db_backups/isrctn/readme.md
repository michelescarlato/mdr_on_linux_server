```
Backing up an object on the server 'PostgreSQL 15 (localhost:5432)' from database 'isrctn'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_dump.exe --file "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_isrctn.backup" --host "localhost" --port "5432" --username "postgres" --no-password --verbose --format=c --blobs "isrctn"
 Start time: Sat Sep 21 2024 18:53:07 GMT+0200 (Central European Summer Time)
...
pg_dump: dumping contents of table "ad.study_iec"
...
pg_dump: dumping contents of table "sd.study_iec"
...
pg_dump: dumping contents of table "te.study_iec"
...
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_restore.exe --host "leman73.homelinux.org" --port "5432" --username "postgres" --no-password --dbname "isrctn" --verbose "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_isrctn.backup"
 Start time: Sat Sep 21 2024 18:53:49 GMT+0200 (Central European Summer Time)
...
pg_restore: creating TABLE "ad.study_iec"
pg_restore: creating SEQUENCE "ad.study_iec_id_seq"
...
pg_restore: creating TABLE "sd.study_iec"
pg_restore: creating SEQUENCE "sd.study_iec_id_seq"
...
pg_restore: creating TABLE "te.study_iec"
pg_restore: creating SEQUENCE "te.study_iec_id_seq"
...
pg_restore: processing data for table "ad.study_iec"
...
pg_restore: processing data for table "sd.study_iec"
...
pg_restore: processing data for table "te.study_iec"
...
pg_restore: executing SEQUENCE SET study_iec_id_seq
...
pg_restore: creating CONSTRAINT "ad.study_conditions study_conditions_new_pkey1"
...
pg_restore: creating CONSTRAINT "ad.study_iec study_iec_new_pkey"
...
pg_restore: creating CONSTRAINT "sd.study_iec study_iec_pkey"
...
pg_restore: creating CONSTRAINT "te.study_iec study_iec_pkey"
...
pg_restore: creating INDEX "ad.study_iec_sid"
...
pg_restore: creating INDEX "sd.study_iec_sid"
...
pg_restore: creating INDEX "te.study_iec_sid"
