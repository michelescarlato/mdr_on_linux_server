```
Backing up an object on the server 'PostgreSQL 15 (localhost:5432)' from database 'euctr'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_dump.exe --file "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_euctr.backup" --host "localhost" --port "5432" --username "postgres" --no-password --verbose --format=c --blobs "euctr"
 Start time: Sat Sep 21 2024 18:30:04 GMT+0200 (Central European Summer Time)
...
pg_dump: dumping contents of table "ad.source_data_to_go"
...
pg_dump: dumping contents of table "ad.temp_dups"
...
Execution time: 21.7 second
```

```
Restoring backup on the server 'krang linux (leman73.homelinux.org:5432)'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_restore.exe --host "leman73.homelinux.org" --port "5432" --username "postgres" --no-password --dbname "euctr" --verbose "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_euctr.backup"
 Start time: Sat Sep 21 2024 18:32:00 GMT+0200 (Central European Summer Time)
...
pg_restore: creating TABLE "ad.source_data_to_go"
...
pg_restore: creating TABLE "ad.temp_dups"
...
pg_restore: processing data for table "ad.source_data_to_go"
...
pg_restore: processing data for table "ad.temp_dups"
...
pg_restore: creating CONSTRAINT "ad.study_iec_13to19 study_iec_13to19_new_pkey1"
