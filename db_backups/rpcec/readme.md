```
Backing up an object on the server 'PostgreSQL 15 (localhost:5432)' from database 'rpcec'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_dump.exe --file "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_rpcec.backup" --host "localhost" --port "5432" --username "postgres" --no-password --verbose --format=c --blobs "rpcec"
 Start time: Sat Sep 21 2024 21:43:00 GMT+0200 (Central European Summer Time)
...
Execution time: 0.78 second
```

```
Restoring backup on the server 'krang linux (leman73.homelinux.org:5432)'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_restore.exe --host "leman73.homelinux.org" --port "5432" --username "postgres" --no-password --dbname "rpcec" --verbose "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_rpcec.backup"
 Start time: Sat Sep 21 2024 21:43:57 GMT+0200 (Central European Summer Time)
...
pg_restore: creating CONSTRAINT "ad.study_conditions study_conditions_pkey"
pg_restore: creating CONSTRAINT "ad.study_countries study_countries_pkey"
...
pg_restore: creating CONSTRAINT "ad.study_iec study_iec_pkey"
pg_restore: creating CONSTRAINT "ad.study_organisations study_organisations_new_pkey1"
pg_restore: creating CONSTRAINT "ad.study_people study_people_pkey"
