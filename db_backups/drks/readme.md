```
Backing up an object on the server 'PostgreSQL 15 (localhost:5432)' from database 'drks'
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_dump.exe --file "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_drks.backup" --host "localhost" --port "5432" --username "postgres" --no-password --verbose --format=c --blobs "drks"
 Start time: Sat Sep 21 2024 18:23:17 GMT+0200 (Central European Summer Time)
...
pg_dump: dumping contents of table "mn.deleted_studies"
...
Running command:
C:\Program Files\pgAdmin 4\v7\runtime\pg_restore.exe --host "leman73.homelinux.org" --port "5432" --username "postgres" --no-password --dbname "drks" --verbose "F:\\MDR_DBBackups\\21_09_2024\\21_09_2024_drks.backup"
 Start time: Sat Sep 21 2024 18:27:09 GMT+0200 (Central European Summer Time)
...
pg_restore: creating TABLE "mn.deleted_studies"
...
pg_restore: processing data for table "mn.deleted_studies"
...
pg_restore: creating CONSTRAINT "ad.study_iec study_iec_new_pkey1"
