```
Backing up an object on the server 'MDR_DB (51.103.39.152:5432)' from database 'cris'
Running command:
/usr/bin/pg_dump --file "/home/michelescarlato/IdeaProjects/mdr_on_linux_server/db_backups/cris/21_09_2024_cris.backup" --host "51.103.39.152" --port "5432" --username "postgres" --no-password --format=c --blobs --verbose "cris"
 Start time: Sat Sep 21 2024 12:49:16 GMT+0200 (Central European Summer Time)
...
Execution time: 261.21 seconds
```

```
Restoring backup on the server 'krang 172.22.68.113 (172.22.68.113:5432)'
Running command:
/usr/bin/pg_restore --host "172.22.68.113" --port "5432" --username "postgres" --no-password --dbname "cris" --verbose "/home/michelescarlato/gitrepo/mdr_on_linux_server/db_backups/cris/21_09_2024_cris.backup"
Start time: Sat Sep 21 2024 15:41:32 GMT+0200 (Central European Summer Time)
...
Successfully completed.
Execution time: 1414.02 seconds
```
